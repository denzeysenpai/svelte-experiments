...
<script lang="ts">
	import DynamicText from '$lib/components/DynamicText/DynamicText.svelte';
	...
	const stresss_data = [
		...
		'Lorem ipsum, dolor sit amet sur.',
		'Lorem ipsum, dolor sit.'
	];
</script>

<div class="fixed-width-sample">
	{#each stresss_data as data}
		<DynamicText text={data} width="850" />
	{/each}
</div>
